 ...
 * illustrates reading chat messages that might contain an imageURL field from
 * the firestore DB using Firestore's realtime updates feature as described in
 *
 ...
 * 
 * This version supports messages containing an imageURL field that references
 * an image stored in Firebase storage.
 * 
 * Like previous versions, it also supports populating the
